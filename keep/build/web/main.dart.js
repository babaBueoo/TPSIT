...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  dart.defineLazy(CT, {
    ...
    get C1() {
      return C[1] = dart.const({
        ...
        [Widget_key]: null,
        [MyHomePage_title]: "EZZ strucca boton"
      });
    },
    get C2() {
      return C[2] = dart.const({
        ...
        [Text_style]: null,
        [Text_textSpan]: null,
        [Text_data]: "Ti ga strucca el boton tante volte:"
      });
    },
    get C4() {
  ...
  main.MyApp = class MyApp extends framework.StatelessWidget {
    ...
    build(context) {
      return new app.MaterialApp.new({title: "am000 strucca boton", theme: theme_data.ThemeData.new({colorScheme: color_scheme.ColorScheme.fromSeed({seedColor: colors.Colors.green}), useMaterial3: true}), home: C[1] || CT.C1});
    }
  };
  ...
  var _decreaseCounter = dart.privateName(main, "_decreaseCounter");
  ...
  main._MyHomePageState = class _MyHomePageState extends framework.State$(main.MyHomePage) {
    ...
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: new text.Text.new(this.widget.title), shadowColor: theme.Theme.of(context).shadowColor, elevation: 10}), body: new basic.Center.new({child: new basic.Column.new({mainAxisAlignment: flex.MainAxisAlignment.center, children: T.JSArrayOfWidget().of([C[2] || CT.C2, new text.Text.new(dart.str(this[_counter]), {style: theme.Theme.of(context).textTheme.headlineMedium})])})}), floatingActionButton: new basic.Column.new({mainAxisAlignment: flex.MainAxisAlignment.end, children: T.JSArrayOfWidget().of([new floating_action_button.FloatingActionButton.new({onPressed: dart.bind(this, _incrementCounter), tooltip: "Increment", child: C[3] || CT.C3}), new basic.SizedBox.new({height: 10}), new floating_action_button.FloatingActionButton.new({onPressed: dart.bind(this, _decreaseCounter), tooltip: "decrease", child: C[5] || CT.C5})])})});
    }
  ...
  dart.setMethodSignature(main._MyHomePageState, () => ({
    ...
    [_decreaseCounter]: dart.fnType(dart.void, []),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
  ...
  }, '{"version":3,"sourceRoot":"","sources":["/zapp/project/.zapp_entry.dart","/zapp/project/lib/main.dart","/zapp/project/.dart_tool/dartpad/web_plugin_registrant.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AA2CI,IA1BF,iCAAgB;AACd,UAAoB,6BAGD;AAF8B,QAA9B,AAAkB,6BAElB,eAF2B;;AAEL,QAAF,CAApB;;AAEnB,UAAO,AAAQ,uBAAY;AAKvB,QAJK,AAAqC,qBAA7B,qCAAuB,uBAAW,QAAC;AAG9C,UAFC,AAAQ,sBAAW,2BAA2B,CAC/C;;;wBAIL,SAAC,GAAG;AACL,UAAO,AAAQ,uBAAY;AAIvB,QAHC,AAAQ,sBAAW,wBAAwB,CAC5C,AAAE,CAAD,eACD,AAAW,UAAD;;2DAGM,yCACb,SAAC,MAAM,QAAQ,MAAM;AAC1B,cAAO,AAAQ,uBAAY;AAC4B,YAAlD,AAAQ,sBAAW,wBAAwB,CAAC,IAAI;;;EAI3D;;AAEiB;AAQd,MAPD,MAAS,gCACC;AACS,UAAf;6CAEe;AACmB,UAAjB;;IAGvB;;;;;;;;;UC7C4B;AACxB,YAAO,iCACE,8BACA,uCACoB,8CAA2B,qCACtC;IAIpB;;;QAZmB;AAAb,8CAAa,GAAG;;EAAE;;;;;;;;;;IAkBX;;;;;;;;;;;;AAGsB;IAAkB;;;QAL7B;QAAmB;;AAArC,mDAAkB,GAAG;;EAAuB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAc9C,MAFF,cAAS;AACG,QAAV,iBAAA,AAAQ,iBAAA;;IAEZ;;AAKI,MAFF,cAAS;AACG,QAAV,iBAAA,AAAQ,iBAAA;;IAEZ;UAG0B;AACxB,YAAO,oCACG,+BACC,kBAAK,AAAO,iCACA,AAAY,eAAT,OAAO,0BAClB,YAEP,6BACG,yCACgC,yCACnB,uCAEhB,kBACa,SAAT,yBACW,AAAY,AAAU,eAAnB,OAAO,0DAKT,yCACiB,sCAC3B,wBACR,0EACa,mCACF,qCAGX,gCACU,MAEV,0EACa,kCACF;IAMnB;;;;;;IArDI,iBAAW;;;EAsDjB;;;;;;;;;;;;;;;AAnFuB,IAArB;EACF;;ECGwB","file":"main.js"}');
  // Exports:
  return {
